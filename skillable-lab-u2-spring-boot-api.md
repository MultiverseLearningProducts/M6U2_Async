...
**Tools:** [start.spring.io](https://start.spring.io/), Java IDE (e.g. IntelliJ), [Hoppscotch](https://hoppscotch.io/) (with Browser Extension for localhost) or Postman.
...
4. **GET** `http://localhost:8080/api/users` – expect an array containing that user.
